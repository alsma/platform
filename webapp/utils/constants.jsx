...
export const Constants = {
    ...
    DND_ICON_SVG: "<?xml version='1.0' encoding='UTF-8' standalone='no'?><!DOCTYPE svg PUBLIC '-//W3C//DTD SVG 1.1//EN' 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'><svg width='100%' height='100%' viewBox='0 0 12 12' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' xml:space='preserve' style='fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;'><g><circle cx='4.5' cy='3' r='2.5' class='online--icon'/></g><path d='M4.1,8.8c0,-0.4 0.1,-0.9 0.2,-1.3c-2.2,-0.2 -2.2,-2 -2.2,-2c0,0 -1,0.1 -1.2,0.5c-0.4,0.6 -0.6,1.7 -0.7,2.5c0,0.1 -0.1,0.5 0,0.6c0.2,1.3 2.2,2.3 4.4,2.4l0.3,0c-0.6,-0.8 -0.8,-1.7 -0.8,-2.7Z' style='fill-rule:nonzero;' class='online--icon'/><text x='6.376px' y='11.098px' style='font-family:\'OpenSans-Bold\', \'Open Sans\', sans-serif;font-weight:700;font-size:8.975px;' class='online--icon'>z</text></svg>",
